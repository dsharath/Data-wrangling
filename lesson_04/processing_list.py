...
def process_file(f):
    ...
    with open("{}/{}".format(datadir, f), "r") as html:
        ...
        flight_data=soup.find("table",{"class":"dataTDRight"})
        for flight_d_row in flight_data.findAll('tr'):
            info={}
            info["courier"],info["airport"]=f[:6].split("_")
            col=flight_d_row.findAll("td")
